...
<sn:ScriptRequest ID="Scriptrequest26" runat="server" Path="$skin/scripts/jquery/plugins/jquery.ba-throttle-debounce.min.js" />
            ...
            var docViewer = $dv.documentViewer({
                ...
                metadataHtml: '\
                            <ul class="docinfo">\
                                ...
                                <li><label>Created by:</label> <span><a href="<%= Actions.ActionUrl(createdbyc, "Profile").Replace("'", "\\'")%>"><%= createdby %></a></span></li>\
                                <li><label>Creation date:</label> <span>' + creDate + '</span></li>\
                                <li><label>Modified by:</label> <span><a href="<%= Actions.ActionUrl(modifiedbyc, "Profile").Replace("'", "\\'")%>"><%= modifiedby %></a></span></li>\
                ...
                pageAttributes: '<%=GetValue("PageAttributes") %>',             //shapes json, default empty string
                SR: {
